...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(55,212,149,0.12) 0%, rgba(10,13,15,0.98) 100%)';
...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(() => ({
    ...
    '--behind-glow-color': behindGlowColor ?? 'rgba(55, 212, 149, 0.5)',
